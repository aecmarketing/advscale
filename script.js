...
(function() {
    ...
    if (form) {
        ...
        // ============================================================
        const GOOGLE_SHEETS_URL = 'https://script.google.com/macros/s/AKfycbzTukETXDOv6vwiFX5TAQ4w1nRPCft53Etygw12ZBeQovgujgFDI6HXSsoWAT2jZ-hVbg/exec';
        ...
        function validateName() {
            ...
            if (val.length < 3) {
                setError(nameInput, nameError, 'Digite seu nome completo (mínimo 3 caracteres)');
                return false;
            }
        ...
        function validateEmail() {
            ...
            const regex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
            if (!regex.test(val)) {
                setError(emailInput, emailError, 'Digite um e-mail válido (ex: nome@dominio.com)');
                return false;
            }
        ...
        function validatePhone() {
            ...
            if (cleaned.length < 10 || cleaned.length > 11) {
                setError(phoneInput, phoneError, 'Digite um telefone válido com DDD (ex: (11) 99999-9999)');
                return false;
            }
        ...
        function validateCity() {
            ...
            if (val.length < 3) {
                setError(cityInput, cityError, 'Digite sua cidade e UF (ex: São Paulo - SP)');
                return false;
            }
        ...
        async function sendToGoogleSheets(data) {
            try {
                ...
                return { success: false, message: 'Erro ao enviar dados. Tente novamente.' };
            }
        }
        ...
        form.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                if (result.success !== false) {
                    ...
                    submitBtn.innerHTML = '<i class="fas fa-check-circle" aria-hidden="true"></i> Enviado com Sucesso!';
                    ...
                    submitBtn.innerHTML = '<i class="fas fa-exclamation-circle" aria-hidden="true"></i> Erro. Tente novamente.';
    ...
    document.querySelectorAll('a[href^="#"]').forEach(function(anchor) {
        anchor.addEventListener('click', function(e) {
            ...
            if (targetEl) {
                e.preventDefault();
                const headerOffset = parseInt(getComputedStyle(document.documentElement).getPropertyValue('--header-height').replace('px', '')) || 84;
                const targetPosition = targetEl.getBoundingClientRect().top + window.pageYOffset - headerOffset - 12;
                window.scrollTo({
                    top: targetPosition,
                    behavior: 'smooth'
                });
    ...
    document.querySelectorAll('.hero__cta, .cta-final__btn, .floating-cta__link, .header__nav-link--cta').forEach(function(btn) {
        if (btn.tagName === 'A') {
